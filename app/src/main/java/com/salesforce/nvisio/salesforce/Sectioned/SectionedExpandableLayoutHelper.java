...
public class SectionedExpandableLayoutHelper implements SectionStateChangeListener {
    ...
    //data list
    private LinkedHashMap<Section, ArrayList<section_item>> mSectionDataMap = new LinkedHashMap<Section, ArrayList<section_item>>();
    ...
    public void addSection(String section, ArrayList<section_item> items) {
        Section newSection;
        mSectionMap.put(section, (newSection = new Section(section)));
        mSectionDataMap.put(newSection, items);
    }

    public void addItem(String section, section_item item) {
        mSectionDataMap.get(mSectionMap.get(section)).add(item);
    }

    public void removeItem(String section, section_item item) {
    ...
    private void generateDataList () {
        ...
        for (Map.Entry<Section, ArrayList<section_item>> entry : mSectionDataMap.entrySet()) {
            Section key;
