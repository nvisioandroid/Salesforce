...
public class SectionedExpandableGridAdapter extends RecyclerView.Adapter<SectionedExpandableGridAdapter.ViewHolder> {
    ...
    //view type
    private static final int VIEW_TYPE_SECTION = R.layout.activity_header;
    private static final int VIEW_TYPE_ITEM = R.layout.activity_item; //TODO : change this
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        switch (holder.viewType) {
            case VIEW_TYPE_ITEM :
                final section_item item = (section_item) mDataArrayList.get(position);
                YoYo.with(Techniques.ZoomInLeft)
                        .duration(200)
                        .playOn(holder.itemTextView);
    ...
    protected static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view, int viewType) {
            ...
            if (viewType == VIEW_TYPE_ITEM) {
                ...
                sectionTextView = (TextView) view.findViewById(R.id.headerName);
